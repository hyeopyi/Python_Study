...
INSERT INTO `movie` VALUES (1,'탑건: 매버릭'),(2,'마녀(魔女) Part2. The Other One'),(3,'범죄도시 2'),(4,'브로커'),(5,'버즈 라이트이어'),(6,'쥬라기 월드: 도미니언'),(7,'극장판 윌벤져스 : 수상한 캠핑 대소동'),(8,'극장판 포켓몬스터DP: 기라티나와 하늘의 꽃다발 쉐이미'),(9,'헤어질 결심'),(10,'룸 쉐어링'),(11,'니 부모 얼굴이 보고 싶다'),(12,'로스트 시티'),(13,'모어'),(14,'니얼굴'),(15,'애프터 양');
...
INSERT INTO `student` VALUES ('b002','관우','심리학과','010-222','서울'),('b003','장비','경제학과','010-333','서울'),('c002','여포','심리학과','016-222','경기'),('c003','손견','경제학과','016-333','경기'),('d001','홍길동','수학과','017-001','광주'),('S001','박소명','컴퓨터공학과','123-4567',NULL),('S002','최민국','컴퓨터공학과','234-5678',NULL),('S005','김상진','사학과','567-8901',NULL),('S006','황정숙','사학과','678-9012',NULL),('S010','James','Computer','1234',NULL),('S777','Cathy','Math','12345',NULL),('S888','James','math','1234',NULL),('S999','홍길동','컴공','123',NULL);
...
-- Dump completed on 2022-06-28 15:44:33
